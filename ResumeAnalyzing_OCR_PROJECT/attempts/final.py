...
if __name__ == "__main__":
    ...
    for role, keywords in job_roles_keywords.items():
        ...
        if shortlisted_resumes:
            ...
            for date1, resume_name, email, job_category in shortlisted_resumes:
                print(f"Interview Date: {date1}")
                ...
                if not result:
                    ...
                    insert_data = (date1, resume_name, email, job_category)
   ...
   # print("Selected Candidates for Each Job Role:")
    ...
    #   print(f"Shortlisted Resumes:{resume_name}")
